...
public class QuadTree<T> {
	...
	/**
	 * Executes executor on all objects inside the Rectangle
	 */
	...
	/** get the minimum x coord of the bounds of the QuadTree */
	public double getMinX() {
		return this.root.getBounds().minX;
	}

	/** get the maximum x coord of the bounds of the QuadTree */
	public double getMaxX() {
		return this.root.getBounds().maxX;
	}

	/** get the minimum y coord of the bounds of the QuadTree */
